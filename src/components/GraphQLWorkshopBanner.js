...
export default function GraphQLWorkshopBanner({
  ...
  button = `Sign Me Up`,
  byline = `Want to learn to build fullstack applications with fast, modern APIs? Our upcoming workshop will fulfill all of your grandest GraphQL desires – from schemas to subscriptions and back again.`,
