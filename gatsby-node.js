...
function createPrivacyPages({ data, actions: { createPage } }) {
  createPage({
    path: '/apps/color-catalog/privacy',
    component: path.resolve(`./src/pages/privacy/color-catalog-app-privacy.js`)
  });
...
exports.createPages = async ({ actions, graphql }) => {
  ...
  createPrivacyPages({ data: {}, actions });
};
