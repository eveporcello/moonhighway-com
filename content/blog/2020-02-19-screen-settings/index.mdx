...
banner: './images/blurry.png'
published: true
---

In a couple weeks, we're going to be celebrating Moon Highway's eighth anniversary. That means that there have been eight years of classes, video recordings, talks, and webinars. There's been a whole lot of typing into a code editor, and one of our main goals when typing into an editor in front of people is making sure that people can read your screen.

It's something that we're obsessed with. When Alex and I sit in on each other's classes, we are each other's screen work watchdogs/worst nightmares. I remember teaching a class and having a text pop up on my iPad (which had my notes) that read simply and condescendingly: "SCREEN! WORK!". I also recall passing a note to Alex during a class that said "NO ONE CARES IF THEY CAN'T READ YOUR SCREEN".

All of this interpersonal and intermarital rudeness only happens because the stakes are high. A readable screen is everything. Over the years, this emphasis on readable code has yielded a few must-do's when it comes to presenting code on a screen. 

## Light or Dark Theme?

As developers, we love dark mode, right? Looking at a light theme is as offensive as if the lid on a vampire's coffin was popped open at 2pm. It's too bright. But dark mode isn't always the easiest to read depending on which room you're in.
