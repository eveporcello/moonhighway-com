...
**TOMORROW!** Friday, April 19, I am going to be on a free egghead.io livestream to cover a ton of features of the query language, the syntax for requesting data from a GraphQL API. Wanting to learn a bit more about GraphQL and the query language is the only prerequisite.

[Sign up for the livestream here](https://egghead.zoom.us/webinar/register/4815544111153/WN_Fd7Acbj-TZeCkaFgZevl7A)!
