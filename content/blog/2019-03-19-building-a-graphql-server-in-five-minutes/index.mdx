...
*Want to learn more about building a GraphQL server? Check out this great tutorial about [building APIs with GraphQL, Node.js, and TypeScript](https://www.toptal.com/graphql/graphql-nodejs-api) on Toptal.*