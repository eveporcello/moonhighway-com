...
_For a more detailed look at how to set up a GraphQL server, check out our playlist on egghead.io: [Create Fullstack Applications with GraphQL and Apollo](https://egghead.io/playlists/create-fullstack-applications-with-graphql-and-apollo-794dc9c7)_.